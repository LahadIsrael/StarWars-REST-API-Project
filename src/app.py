...
@app.route('/users/favorites/character/<int:character_id>', methods=['POST'])
...
def delete_favorite_planet(user_id, planet_id):
    ...
    if favorite_user_planet is None:
        return jsonify('Could not user favorite planet!')
...
def delete_favorite_character(user_id, character_id):
    ...
    if favorite_user_character is None:
        return jsonify('Could not user favorite character!')
